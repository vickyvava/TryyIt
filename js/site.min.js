...
//site.js
var b={},b={j:function(){this.l();this.k();this.m();this.g();this.n()},l:function(){$("#mobile-button").J({B:275,t:"left",r:!0});$(".owl-carousel").F({loop:!0,D:!1,s:!1,w:!0,items:1,G:!1,I:!0,H:{0:{items:1},600:{items:1},1E3:{items:1}}});$(".controls").d("click",function(){var a=$(".owl-carousel").data("owlCarousel");$(this).c("left")?a.i():a.next()});$(".demo-controls").d("click",function(){var a=$("#slid").data("owlCarousel");$(this).c("left")?a.i():a.next();$(document).p("scroll")});$(".pricing-controls").d("click",function(){var a=$("#mobile-pricing-slider .owl-carousel").data("owlCarousel");$(this).c("lefts")?a.i():a.next()});b.e()&&$("#products").find("a").h(function(){$(this).a("btn-floating").b("btn-large")});$(".product-control").d("click",function(){$("#products").find("a").b("transparent black white-text").a("grey lighten-4 black-text");$(this).b("grey lighten-4 black-text").a("black white-text");b.e()&&($("#products").find("a").b("transparent black").a("transparent"),$("#products").find("a").find("span.hide-on-large-only i").b("white-text").a("black-text"),$(this).b("transparent black-text").a("black"),$(this).find("span.hide-on-large-only i").a("white-text").b("black-text"));$("#product-features").find("article#"+$(this).f("data-target")).b("hide");$("#product-features").find("article#"+$(this).f("data-target")).o("article[id*=product-categories]").a("hide");$(document).p("scroll");b.g()});$("#web-header a").d("click",function(){$("html,body").q({scrollTop:$("#"+$(this).f("data-target")).offset().top},"slow")});$(".seeMore").d("click",function(){$("#full-details").is(":visible")? ($("#full-details").L("slow"),$(this).text("Show Detailed Features")):($("#full-details").K("slow"),$(this).text("Hide Detailed Features"))});$("#pricing .card").v(function(){$(this).b("transparent").a("white");$(this).find(".card-image").a("cyan-text").b("black-text");$(this).find(".card-content a.btn").b("black-text wht-bdr").a("cyan-text blk-bdr")},function(){$(this).a("transparent").b("white");$(this).find(".card-image").b("cyan-text").a("black-text");$(this).find(".card-content a.btn").a("black-text wht-bdr").b("cyan-text blk-bdr")})},k:function(){$("img.lazy, img , .image").A({u:"fadeIn"})},m:function(){$(document).scroll(function(){50<$(this).scrollTop()?($("#web-header").a("cyan z-depth-1").b("transparent z-depth-0"),$("#site-wrapper #site-navbar").b("big"),$("#site-navbar").find(".hide-on-med-and-down li a").a("white-text").b("black-text")):($("#web-header").a("transparent z-depth-0").b("cyan z-depth-1"),$("#site-wrapper #site-navbar").a("big"),$("#site-navbar").find(".hide-on-med-and-down li a").a("black-text").b("white-text"));$("#site-navbar .brand-logo img").f("data-original","img/tryIt_white.png")})},g:function(){this.e||$(".big-bro").h(function(){var a=$(this),c=$(this).o(".small-bro");$(c).height($(a).height()).a("valign-wrapper");$(c).children().a("valign-wrapper")})},e:function(){var a=!1;(new MobileDetect(window.navigator.userAgent)).C()&&(a=!0);return a},n:function(){b.e()&&$("#introduction div, #product-features div").h(function(){$(this).c("mar-tb-5")&&$(this).b("mar-tb-5");($(this).c("right-align")||$(this).c("left-align"))&&$(this).b("right-align left-align").a("center-align")})}};b.j();